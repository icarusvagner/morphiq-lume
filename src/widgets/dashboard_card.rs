use iced::{
	Alignment, Length, alignment::{Horizontal, Vertical}, widget::{Column, Container, Row, Text, container}
};

use crate::{
	core::{
		theme::fonts::{OUTFIT_BOLD, RALEWAY_BOLD, RALEWAY_REGULAR}, utils::{icon::Icon, message::Message}
	}, styles::{container::ContainerType, style_type::StyleType, text::TextType}
};
