...
use iced::{Font, Settings, Task, window};
...
use crate::{
	configs::{
		...
		morphiq::{FONT_FAMILY_NAME, Morphiq}, styles::style_constant::fonts::{
			FONT_SIZE_BODY, ICONS_BYTES, OUTFIT_BLACK_BYTES, OUTFIT_BOLD_BYTES, OUTFIT_EXTRABOLD_BYTES, OUTFIT_EXTRALIGHT_BYTES, OUTFIT_LIGHT_BYTES, OUTFIT_MEDIUM_BYTES, OUTFIT_REGULAR_BYTES, OUTFIT_SEMIBOLD_BYTES, OUTFIT_THIN_BYTES, RALEWAY_BLACK_BYTES, RALEWAY_BLACK_ITALIC_BYTES, RALEWAY_BOLD_BYTES, RALEWAY_BOLD_ITALIC_BYTES, RALEWAY_EXTRA_BOLD_BYTES, RALEWAY_EXTRA_BOLD_ITALIC_BYTES, RALEWAY_EXTRA_LIGHT_BYTES, RALEWAY_EXTRA_LIGHT_ITALIC_BYTES, RALEWAY_ITALIC_BYTES, RALEWAY_LIGHT_BYTES, RALEWAY_LIGHT_ITALIC_BYTES, RALEWAY_MEDIUM_BYTES, RALEWAY_MEDIUM_ITALIC_BYTES, RALEWAY_REGULAR_BYTES, RALEWAY_SEMI_BOLD_BYTES, RALEWAY_SEMI_BOLD_ITALIC_BYTES, RALEWAY_THIN_BYTES, RALEWAY_THIN_ITALIC_BYTES
	...
	iced::application(MORPHIQ_TITLECASE, Morphiq::update, Morphiq::view)
		.settings(Settings {
			...
			fonts: [
				...
				// Iced aw icon bytes
				Cow::Borrowed(REQUIRED_FONT_BYTES),
			]
			.to_vec(),
