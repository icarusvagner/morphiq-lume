...
impl TextInputType {
    ...
    fn hovered(&self, style: &StyleType) -> Style {
        ...
        Style {
            ...
            border: Border {
                color: match self {
                    TextInputType::Base100 | TextInputType::Base200 | TextInputType::Base300 => {
                        self.lighten_color(colors.base_100)
                    }
                    TextInputType::Primary => colors.primary,
                    TextInputType::Secondary => colors.secondary,
                    TextInputType::Accent => colors.accent,
    ...
    fn focused(&self, style: &StyleType) -> Style {
        ...
        Style {
            ...
            border: match self {
                ...
                _ => Border {
                    color: match self {
                        TextInputType::Primary => self.lighten_color(colors.primary),
                        TextInputType::Secondary => self.lighten_color(colors.secondary),
                        TextInputType::Accent => self.lighten_color(colors.accent),
                        TextInputType::Neutral => self.lighten_color(colors.neutral),
                        TextInputType::Info => self.lighten_color(colors.info),
                        TextInputType::Success => self.lighten_color(colors.success),
                        TextInputType::Warning => self.lighten_color(colors.warning),
                        TextInputType::Error => self.lighten_color(colors.error),
