...
fn get_argon2() -> &'static Argon2<'static> {
    ...
    INSTANCE.get_or_init(|| {
        ...
        .expect("Failed to create argon2 with secret") // TODO - needs to fail early
    })
}
...
mod tests {
    ...
    fn test_scheme_02_hash_into_b64u_ok() -> Result<()> {
        ...
        let fx_res = "$argon2id$v=19$m=19456,t=2,p=1$8F6JYdatQIaeeKbeBl5UUw$+98rn+1Le7ynHSQrg9BarP51nCRiBV/7bakT4UnCljY";
