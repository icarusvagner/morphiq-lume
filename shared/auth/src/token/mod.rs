...
use lume_utils::b64::{b64u_decode_to_string, b64u_encode};
use lume_utils::time::{now_utc, now_utc_plus_sec_str, parse_utc};
use std::fmt::Display;
use std::str::FromStr;
use uuid::Uuid;
...
mod tests {
    ...
    fn test_token_validate_web_token_ok() -> Result<()> {
        ...
        let fx_salt = Uuid::parse_str("f05e8961-d6ad-4086-9e78-a6de065e5453")
            .expect("Failed to parse UUID to str");
    ...
    fn test_token_validate_web_token_err_expired() -> Result<()> {
        ...
        let fx_user = "user_one";
        let fx_salt = Uuid::parse_str("f05e8961-d6ad-4086-9e78-a6de065e5453")
            .expect("Failed to parse UUID to std");
